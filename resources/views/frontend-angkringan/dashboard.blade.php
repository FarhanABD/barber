@include('frontend-angkringan.layouts.header')
    ...
    <div class="branding d-flex align-items-center">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        <a href="index.html" class="logo d-flex align-items-center">
          ...
          {{-- <img src="{{ asset('frontend/images/logo-angkringan-remove.png') }}" style="transform: scale(2.4)" alt="">  --}}
          <h1 class="sitename">Antarsukha</h1>
        </a>
        @include('frontend-angkringan.layouts.nav')
      </div>
    </div>
  </header>
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      <div class="hero-background">
        <video autoplay="" muted="" loop="" playsinline="">
          <source src="{{ asset('frontend-angkringan/img/restaurant/video-4.mp4') }}" type="video/mp4">
        </video>
        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="hero-text" data-aos="fade-up" data-aos-delay="100">
              <span class="tagline">Nongkrong Dulu, Ganteng Kemudian</span>
              <h1 class="hero-title">Antarsukha — tempat nongkrong dan gaya bertemu</h1>
              <p class="hero-description">Nikmati hangatnya angkringan, obrolan tanpa batas, dan potongan rambut yang bikin percaya diri — semua dalam satu tempat yang nyaman</p>

              <div class="hero-actions" data-aos="fade-up" data-aos-delay="200">
                <a href="https://wa.me/6285784466395?text=Halo%20Admin%20Angkringan%20Antarsukha,%20saya%20ingin%20melakukan%20booking.%20Mohon%20informasinya%20ya.%20Terima%20kasih." class="btn btn-primary">Book a Table</a>
              ...
              <div class="hero-features" data-aos="fade-up" data-aos-delay="300">
                <div class="feature-item">
                  ...
                  <div class="feature-text">
                    ...
                    <span class="value">09.00 - 03.00</span>
                  </div>
                </div>
                <div class="feature-item">
                  ...
                  <div class="feature-text">
                    ...
                    <span class="value">Jln Semeru, Tegal Boto Kidul</span>
                  </div>
                </div>
                <div class="feature-item">
                  ...
                  <div class="feature-text">
                    ...
                    <span class="value">085258882652</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="col-lg-4">
        <div class="hero-image-wrapper" data-aos="fade-left" data-aos-delay="150">
          <img 
            src="{{ asset('frontend/images/logo-angkringan-remove.png') }}" 
            alt="Antarsukha angkringan dan barbershop"
            class="hero-image"
          >
        </div>
      </div>
    ...
    <section id="about" class="about section">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <h2>Tentang Antarsukha</h2>
        <p>Angkringan Modern dengan profesionalisme Barbershop Eksklusif</p>
        ...
        <div class="row g-5 align-items-center">
          <div class="col-lg-6" data-aos="fade-up">
            <div class="about-content">
              <h2>Cita Rasa Otentik & Modern</h2>
              <p>Nikmati menu angkringan  yang khas dan higienis dengan sentuhan presentasi modern. Mulai dari aneka sate-satean hingga kopi yang menyegarkan, semuanya tersedia untuk menemani waktu santai Anda.</p>

              <div class="row mt-4">
                <div class="col-md-6">
                  <div class="feature-item" data-aos="fade-up" data-aos-delay="150">
                    <i class="bi bi-award"></i>
                    <h4>Kenyamanan Tanpa Batas</h4>
                    <p>Nikmati layanan potong rambut premium sambil pesen kopi atau camilan khas angkringan kita.</p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="feature-item" data-aos="fade-up" data-aos-delay="200">
                    <i class="bi bi-trophy"></i>
                    <h4>Modern Concept</h4>
                    <p>Level up gaya lo sambil ngopi santai. Definisi baru tempat nongkrong yang gak cuma fungsional, tapi juga estetik.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
            <div class="about-gallery">
              <div class="row g-3">
                <div class="col-6">
                  <img src="{{ asset('frontend/images/about1.jpeg') }}" class="img-fluid rounded" alt="Restaurant Image">
                </div>
                <div class="col-6">
                  <img src="{{ asset('frontend/images/about4.jpeg') }}" class="img-fluid rounded" alt="Restaurant Image">
                </div>
                <div class="col-12 mt-3">
                  <div class="years-badge">
                    {{-- <span class="number"></span> --}}
                    <span class="text">Grand Opening</span>
                  </div>
                  <img src="{{ asset('frontend/images/about3.jpeg') }}" class="img-fluid rounded" alt="Restaurant Image">
                </div>
              </div>
            </div>
          </div>
    ...
    <section id="menu" class="menu section">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <h2>Menu</h2>
        <p>Menu pilihan angkringan Antarsukha</p>
      </div><!-- End Section Title -->
    ...
    <ul>
        ...
        @foreach ($listCategories as $category)
            <li data-filter=".filter-{{ Str::slug($category->nama) }}">
                {{ $category->nama }}
            </li>
        @endforeach
    </ul>
...
@foreach ($listCategories as $category)
    ...
    <div class="col-xl-4 col-lg-6 isotope-item filter-{{ Str::slug($category->nama) }}">
        <div class="menu-card">
...
@endforeach
          ...
          <div class="row align-items-center">
            <div class="col-md-8">
              <div class="seasonal-notice">
                ...
                <span>Our seasonal menu changes quarterly. Some items may vary based on ingredient availability.</span>
              </div>
            </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile">
                  <img src="{{ asset('frontend-angkringan/img/person/person-m-9.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile">
                  <img src="{{ asset('frontend-angkringan/img/person/person-f-5.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile">
                  <img src="{{ asset('frontend-angkringan/img/person/person-f-12.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>Quis quorum aliqua sint quem legam fore sunt eram irure aliqua veniam tempor noster veniam enim culpa labore duis sunt culpa nulla illum cillum fugiat legam esse veniam culpa.</p>
                <div class="profile">
                  <img src="{{ asset('frontend-angkringan/img/person/person-m-12.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <div class="profile">
                  <img src="{{ asset('frontend-angkringan/img/person/person-m-13.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                ...
                <p>Texit tempor illum tamen malis malis eram quae irure esse labore quem cillum quid cillum eram malis quorum velit fore eram velit sunt aliqua noster fugiat irure amet legam anim culpa.</p>
                <div class="profile">
                  <img src="{{ asset('frontend-angkringan/img/person/person-f-13.webp') }}" class="testimonial-img" alt="" loading="lazy">
                  <div class="info">
        ...
        <div class="featured-chef row align-items-center g-4" data-aos="fade-up" data-aos-delay="150">
          ...
          <div class="col-lg-7">
            <div class="chef-content">
              ...
              <p class="bio mb-4">Curabitur convallis lectus a sapien dictum, sed posuere urna fermentum. Maecenas sodales, neque non pretium ultrices, lacus nibh finibus mi, non vulputate arcu quam at nisl.</p>
                ...
                <div class="col-lg-7" data-aos="fade-left" data-aos-delay="300">
                  <div class="reservation-info-section">
                    <div class="hero-image">
                      <img src="{{ asset('frontend-angkringan/img/restaurant/showcase-2.webp') }}" alt="Restaurant dining area" class="img-fluid">
          ...
          <div class="row align-items-center">
            <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="250">
              <div class="awards-content">
                ...
                <p>At enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
              </div>
            </div>
    ...
    <section id="gallery" class="gallery section">
      <div class="container section-title" data-aos="fade-up">
        <span class="description-title">Gallery Antarsukha</span>
        <h2>Gallery Antarsukha</h2>
        <p>Gallery Antarsukha Angkringan & Barber</p>
      </div>
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <div class="row g-3 isotope-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6 isotope-item filter-food">
              <figure class="gallery-card">
                <a href="assets/img/restaurant/main-3.webp" class="glightbox" data-gallery="restaurant-gallery">
                  <img src="{{ asset('frontend/images/about1.jpeg') }}" alt="Grilled Salmon" class="img-fluid rounded" loading="lazy">
                </a>
              ...
              <div class="col-lg-4 col-md-6 isotope-item filter-food">
              <figure class="gallery-card">
                <a href="{{ asset('frontend/images/about2.jpeg') }}" class="glightbox" data-gallery="restaurant-gallery">
                  <img src="{{ asset('frontend/images/about2.jpeg') }}" alt="Raspberry Tart" class="img-fluid rounded" loading="lazy">
                </a>
             ...
             <div class="col-lg-4 col-md-6 isotope-item filter-food">
              <figure class="gallery-card">
                <a href="{{ asset('frontend/images/about3.jpeg') }}" class="glightbox" data-gallery="restaurant-gallery">
                  <img src="{{ asset('frontend/images/about3.jpeg') }}" alt="Beef Fillet" class="img-fluid rounded" loading="lazy">
                </a>
            ...
            <div class="col-lg-4 col-md-6 isotope-item filter-interior">
              <figure class="gallery-card">
                <a href="{{ asset('frontend/images/about4.jpeg') }}" class="glightbox" data-gallery="restaurant-gallery">
                  <img src="{{ asset('frontend/images/about4.jpeg') }}" alt="Dining Hall" class="img-fluid rounded" loading="lazy">
                </a>
            ...
            <div class="col-lg-4 col-md-6 isotope-item filter-interior">
              <figure class="gallery-card">
                <a href="{{ asset('frontend/images/about4.jpeg') }}" class="glightbox" data-gallery="restaurant-gallery">
                  <img src="{{ asset('frontend/images/about4.jpeg') }}" alt="Bar Area" class="img-fluid rounded" loading="lazy">
                </a>
            </div>
    ...
    <section id="contact" class="contact section light-background">
        ...
        <div class="row gy-4 mb-5">
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="contact-info-box">
              ...
              <div class="info-content">
                <h4>Alamat Kami</h4>
                <p>RPFF+9P5, Tegal Boto Kidul, Sumbersari, Kec. Sumbersari, Kabupaten Jember, Jawa Timur 68124</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
            <div class="contact-info-box">
              ...
              <div class="info-content">
                ...
                <p>Senin: 09:00 - 03:00</p>
                <p>Rabu - Minggu: 09:00 - 03:00</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3949.2597907185727!2d113.72431250000001!3d-8.176562499999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd6953054a5bd15%3A0x2d36d945d30607fe!2sAngkringan%2C%20Coffee%2C%20Barbershop%20Antarsukha!5e0!3m2!1sid!2sid!4v1767955621001!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
    </section><!-- /Contact Section -->
  </main>

 @include('frontend-angkringan.layouts.footer')
</body>
