...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <form action="{{ route('admin.pengeluaran-gaji.store') }}" method="POST" id="formGaji">
                @csrf
                <input type="hidden" name="skema_gaji" id="skema_gaji" value="jam_kerja">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" name="periode_mulai" class="form-control @error('periode_mulai') is-invalid @enderror" value="{{ old('periode_mulai') }}">
                                        @error('periode_mulai')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" name="periode_selesai" class="form-control @error('periode_selesai') is-invalid @enderror" value="{{ old('periode_selesai') }}">
                            ...
                            <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="input-group input-group-sm" style="width: 110px;">
                                        <input type="number" step="1" min="0" max="100" name="persentase_komisi" id="persentase_komisi" class="form-control text-right font-weight-bold" value="45">
                                    ...
                                    <table class="table table-bordered table-sm" id="table_layanan_barber">
                                        ...
                                        <tbody id="barber_service_rows">
                                            @php
                                                if (isset($barberServices) && $barberServices->count() > 0) {
                                                    $servicesList = $barberServices->map(function($s) {
                                                        return [
                                                            'nama' => $s->name,
                                            ...
                                            <tr class="barber-row">
                                                ...
                                                <td class="text-center align-middle font-weight-bold text-muted srv-komisi-rate">
                                                    Rp {{ number_format($srv['tarif'] * 0.45, 0, ',', '.') }}
                                                </td>
                                                <td>
                                                    <input type="number" name="rincian_layanan[{{ $idx }}][jumlah_kepala]" class="form-control form-control-sm text-center font-weight-bold srv-qty" value="0" min="0" step="1">
                                                </td>
                                        ...
                                        <tfoot>
                                            <tr style="background-color: #f8f9fa;">
                                                ...
                                                <td class="text-center font-weight-bold text-primary" id="total_barber_kepala_text">0 Kepala</td>
                                                <td class="text-right font-weight-bold text-success" id="total_barber_komisi_text">Rp 0</td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <div class="input-group">
                                                <input type="number" step="0.5" min="0" name="total_jam_kerja" id="total_jam_kerja" class="form-control text-right font-weight-bold @error('total_jam_kerja') is-invalid @enderror" value="{{ old('total_jam_kerja', 0) }}" placeholder="0">
                                                <div class="input-group-append">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="tarif_per_jam" id="tarif_per_jam" class="form-control text-right font-weight-bold" value="{{ old('tarif_per_jam', 5000) }}" min="0">
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-2">
                                            <label class="form-label text-muted">Subtotal Upah Jam</label>
                                            <h5 class="text-primary font-weight-bold mb-0" id="subtotal_jam_kerja_text">Rp 0</h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="p-3 mb-3 rounded" style="background-color: #fcf8e3; border: 1px solid #faebcc;">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <div class="input-group">
                                                <input type="number" step="0.5" min="0" name="jam_training" id="jam_training" class="form-control text-right font-weight-bold" value="{{ old('jam_training', 0) }}" placeholder="0">
                                                <div class="input-group-append">
                                                    <span class="input-group-text">Jam</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="tarif_training_per_8jam" id="tarif_training_per_8jam" class="form-control text-right font-weight-bold" value="{{ old('tarif_training_per_8jam', 20000) }}" min="0">
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-2">
                                            <label class="form-label text-muted">Subtotal Fee Training</label>
                                            <h5 class="text-success font-weight-bold mb-0" id="subtotal_training_text">Rp 0</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="bonus" id="bonus" class="form-control text-right font-weight-bold" value="{{ old('bonus', 0) }}" min="0">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="potongan" id="potongan" class="form-control text-right font-weight-bold" value="{{ old('potongan', 0) }}" min="0">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-0">
                                    ...
                                    <textarea name="catatan" class="form-control" rows="2" placeholder="Catatan khusus untuk slip gaji ini...">{{ old('catatan') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="card card-hero">
                            <div class="card-header" style="background: linear-gradient(135deg, #47c363 0%, #178d33 100%); color: white; padding: 25px;">
                                ...
                                <h2 class="text-white font-weight-bold mt-2" id="grand_total_display">Rp 0</h2>
                            </div>
                            <div class="card-body">
                                <ul class="list-group list-group-flush mb-4">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center px-0" id="summary_barber_row" style="display: none;">
                                        ...
                                        <strong class="text-primary" id="ringkasan_barber_komisi">Rp 0</strong>
                                    </li>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center px-0" id="summary_angkringan_jam_row">
                                        ...
                                        <strong id="ringkasan_upah_jam">Rp 0</strong>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center px-0" id="summary_angkringan_training_row">
                                        ...
                                        <strong class="text-success" id="ringkasan_fee_training">+ Rp 0</strong>
                                    </li>

                                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                        <span>Bonus Tambahan</span>
                                        <strong class="text-success" id="ringkasan_bonus">+ Rp 0</strong>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                        <span>Potongan</span>
                                        <strong class="text-danger" id="ringkasan_potongan">- Rp 0</strong>
                                    </li>
                                </ul>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <select name="status" class="form-control">
                                        <option value="dibayar" {{ old('status', 'dibayar') == 'dibayar' ? 'selected' : '' }}>Sudah Dibayar (Lunas)</option>
                                        <option value="pending" {{ old('status', 'pending') == 'pending' ? 'selected' : '' }}>Pending / Menunggu</option>
                                    </select>
                                </div>

                                <button type="submit" class="btn btn-success btn-lg btn-block">
                                    <i class="fas fa-save mr-1"></i> Simpan Slip Gaji
                                </button>
