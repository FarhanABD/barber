                ...
                <div class="col-12 col-md-10 offset-md-1">
                    <div class="card">
                        <div class="card-header">
                            <h4>Formulir Data Karyawan</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.master-karyawan.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama') }}" required placeholder="Contoh: Budi Santoso">
                                        @error('nama')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="divisi" class="form-control @error('divisi') is-invalid @enderror" required>
                                            ...
                                            <option value="angkringan" {{ old('divisi') == 'angkringan' ? 'selected' : '' }}>Angkringan</option>
                                            <option value="barber" {{ old('divisi') == 'barber' ? 'selected' : '' }}>Barber</option>
                                            <option value="lainnya" {{ old('divisi') == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                                        </select>
                                        @error('divisi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="3" placeholder="Masukkan alamat tempat tinggal karyawan...">{{ old('alamat') }}</textarea>
                                        @error('alamat')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
