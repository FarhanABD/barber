        ...
        <div class="section-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.mitras.update', $mitra->id_mitra) }}"
                                  method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="status"
                                            ...
                                            <option value="1"
                                                {{ old('status', $mitra->status) == '1' ? 'selected' : '' }}>
                                                Aktif
                                            </option>
                                            <option value="0"
                                                {{ old('status', $mitra->status) == '0' ? 'selected' : '' }}>
                                                Nonaktif
                                            </option>
                                        </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="alamat"
                                              ...
                                              rows="3">{{ old('alamat', $mitra->alamat) }}</textarea>
